 ...
 */
public class AboutCompanyAdapter extends ArrayAdapter<CompanyItem> {
    ...
    public AboutCompanyAdapter(Context context, int resource, List<CompanyItem> companyItems) {
